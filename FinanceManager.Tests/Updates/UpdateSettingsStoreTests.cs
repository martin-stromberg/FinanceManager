...
public sealed class UpdateSettingsStoreTests
{
    ...
    public async Task GetAsync_AppliesPersistedWorkingDirectoryAfterRestart()
    {
        ...
        try
        {
            ...
            await firstStore.SaveAsync(new UpdateSettingsUpdateRequest(false, 60, "martin-stromberg", "FinanceManager", "update.json", null, null, null, null, "custom-updates", 120));
