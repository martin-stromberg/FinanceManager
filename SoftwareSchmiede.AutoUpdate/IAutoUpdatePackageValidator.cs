...
public interface IAutoUpdatePackageValidator
{
    ...
    /// </summary>
    /// <param name="installedVersion">The currently installed version, or <see langword="null"/> if unknown.</param>
    /// <param name="availableVersion">The version reported by the update source.</param>
    /// <returns><see langword="true"/> if <paramref name="availableVersion"/> is newer; otherwise <see langword="false"/>.</returns>
