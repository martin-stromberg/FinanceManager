...
Branch: `task/issue-349-c02f99639a7f41fa91dab7e9fee6c9e7-speichern-von-massenaenderunge`

| Status | Schritt | Beschreibung | Artefakt |
|--------|---------|--------------|----------|
| [x] | 1 | Branch-Name ermitteln | – |
| [x] | 2 | Verzeichnisstruktur vorbereiten | `docs/features/task/issue-349-c02f99639a7f41fa91dab7e9fee6c9e7-speichern-von-massenaenderunge/` |
| [x] | – | Einstiegspunkt ermitteln (keine Artefakte vorhanden, Start bei Schritt 3) | – |
