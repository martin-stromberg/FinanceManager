...
referenziert als lokales NuGet-Paket `msTools.Updater 0.10.0-rc.1` unter
`external/msTools.Updater/msTools.Updater.0.10.0-rc.1.nupkg`. Updates koennen aus GitHub-Releases
